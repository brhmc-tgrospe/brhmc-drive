  ...
  <div class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-lg bg-white rounded-xl shadow-2xl flex flex-col border border-slate-200 overflow-hidden animate-fade-in-up">
      ...
      <div class="p-4 sm:p-6 flex-1 overflow-y-auto">
        <ScheduleForm :form="form" :drivers="drivers" :vehicles="vehicles" :is-edit="true" :original-driver-id="props.shift.driver_id" :original-vehicle-id="props.shift.vehicle_id" @submit="submitShift" id="scheduleForm">
