<template>
  <form @submit.prevent="submit" class="space-y-3 sm:space-y-4">
    ...
    <div>
      ...
      <input v-model="form.password" type="password" :required="!isEdit" minlength="6" class="w-full bg-slate-50 border border-slate-200 rounded px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm focus:ring-2 focus:ring-teal-500 outline-none">
    </div>
